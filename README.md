...
Aplicação fullstack desenvolvida com Next.js 15 e TypeScript, utilizando as novas features de Server Components e Client Components para otimizar a renderização e a experiência do usuário.
